        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    ...
                    <div class="box-body table-responsive">
                        <table id="gallary_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>ID</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            if ($('#gallary_table').length > 0) {
            var tableData = $('#gallary_table').DataTable({
                    //stateSave: true,
