...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!--font-family-->
		<link href="{{URL::asset('https://fonts.googleapis.com/css?family=Rufina:400,700')}}" rel="stylesheet" />

		<link href="{{URL::asset('https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900')}}" rel="stylesheet" />
	...
	<body>
		<!--[if lte IE 9]>
		<p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="{{URL::asset('https://browsehappy.com/')}}">upgrade
		...
		<!--modernizr.min.js-->
		<script  src="{{URL::asset('https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js')}}"></script>
		...
		<script src="{{URL::asset('assets/js/jquery.filterizr.min.js')}}"></script>
